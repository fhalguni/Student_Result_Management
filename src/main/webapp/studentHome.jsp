...
try{
	...
	String rollnum=request.getParameter("rollNo");
     		...
     		ResultSet rs=st.executeQuery("select * from student join result on student.rollnum=result.rollnum where student.rollnum='"+rollnum+"'");
     		if(rs.next()){
%>
<style>
	img {
...
<src="KITlogo.jpeg"  align="left"width="150" height="150">

<img src="kitlogo.jpg" class="image round" align="right"  width="150" height="150"></center>
...
body{
  background: -webkit-linear-gradient(left, #4db6ac, #1976D2);
	background: linear-gradient(to right, #4db6ac, #1976D2);
...
<body>
  ...
  <hr class="new1">
<center><h6>All Right Reserved @Ashwini :: 2023-2024</h6></center> 
  <hr class="new1">
</body>
<%}
else{
