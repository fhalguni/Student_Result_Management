...
<center><img class="image round" src="KITlogo.jpeg" width="100" height="100" border-radius="50px">
<img class="image round" src="kitlogo.jpg" align="right"  width="100" height="100" border-radius="50px"></center>
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact KIT.
</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @Ashwini :: 2023-2024</h5></center> 
  <hr class="new1">
<br>
</body>
</html>